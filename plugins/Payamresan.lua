...
fwd_msg("user#id"..tonumber(fwd_to), msg.id,ok_cb,false)
  return 'سلام دوست عزیز***ربات ضد لینک-ضد اسپم-ضد فش ووووو با امکانات تفریحی داریم***هزینه ماهانه ربات 7 هزار تومن هست***هزینه هم بصورت کارت ب کارت و هم بصورت شارژ پذیرفته میشه***اگه قصد خرید داری اسمت اسم گروهت و لینکش و یه شماره تلفن همینجا بذار***ااگه نمیخوای بخری لطفا مزاحم نشو تشکر'
