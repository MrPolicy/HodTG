...
VOLUNTARYCHECK=0
I=1
BOT=HodTG  # You can put here other bots. Also you can change it to run more than one bot in the same server.
...
echo -e "               \e[01;34m                    by HodTeam / @SOLiD021                 \e[00;37;40m"
echo ""
cat << EOF
...
echo ""
echo -e "\033[38;5;208m @HodTeam-----@HodTeam\033[0;00m"
echo -e "\033[38;5;208m @HodTeam-----@HodTeam\033[0;00m"
echo -e "\033[38;5;208m @HodTeam-----@HodTeam\033[0;00m"
echo -e "\033[38;5;208m @HodTeam-----@HodTeam\033[0;00m"
echo -e "\033[38;5;208m @HodTeam-----@HodTeam\033[0;00m"
